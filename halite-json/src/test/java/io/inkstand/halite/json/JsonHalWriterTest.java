...
public class JsonHalWriterTest {
    ...
    public void testJsonHalWriterJsonGenerator() throws Exception {
        ...
        assertFalse((Boolean) writer.getOption(JsonHalWriter.Option.CLOSE_ON_WRITE_RESOURCE));
    ...
    public void testJsonHalWriterWriter() throws Exception {
        ...
        assertTrue((Boolean) writer.getOption(JsonHalWriter.Option.CLOSE_ON_WRITE_RESOURCE));
    }
    ...
    public void testWrite_resource_closeOnWrite() throws Exception {
        ...
        this.subject.setOption(JsonHalWriter.Option.CLOSE_ON_WRITE_RESOURCE, true);
        this.subject.write(pojo);
        final String expected = "{"
                + "\"_links\": { "
                + "\"self\": {\"href\":\"pojo\"},"
    ...
    public void testWrite_resource_writeNulls() throws Exception {
        ...
        this.subject.setOption(JsonHalWriter.Option.WRITE_NULLS, true);
        this.subject.write(pojo);
        final String expected = "{"
                + "\"_links\": { "
                + "\"self\": {\"href\":\"pojo\", "
    ...
    public void testWriteObjectValue_emptyResource_writeEmptyEmbedded() throws Exception {
        this.subject.setOption(JsonHalWriter.Option.WRITE_EMPTY_EMBEDDED, true);
        final Resource res = createResource();
    ...
    public void testSetOption_validOption() throws Exception {
        this.subject.setOption(JsonHalWriter.Option.WRITE_NULLS, Boolean.TRUE);
        assertTrue((Boolean) this.subject.getOption(JsonHalWriter.Option.WRITE_NULLS));
        this.subject.setOption(JsonHalWriter.Option.WRITE_NULLS, Boolean.FALSE);
        assertFalse((Boolean) this.subject.getOption(JsonHalWriter.Option.WRITE_NULLS));
    }
    ...
    public void testIsSetOption_defaultOptions_true() throws Exception {
        assertTrue(this.subject.isSetOption(JsonHalWriter.Option.WRITE_NULLS));
        assertTrue(this.subject.isSetOption(JsonHalWriter.Option.WRITE_EMPTY_EMBEDDED));
        assertTrue(this.subject.isSetOption(JsonHalWriter.Option.CLOSE_ON_WRITE_RESOURCE));
    }
    ...
    public void testGetOption_defaultValues() throws Exception {
        assertFalse((Boolean) this.subject.getOption(JsonHalWriter.Option.WRITE_NULLS));
        assertFalse((Boolean) this.subject.getOption(JsonHalWriter.Option.WRITE_EMPTY_EMBEDDED));
        assertFalse((Boolean) this.subject.getOption(JsonHalWriter.Option.CLOSE_ON_WRITE_RESOURCE));
    }
